...
export function RegisterRoutes(app: express.Router) {
  ...
  app.get(
    ...
    function StatusController_getStatus(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getStatus.apply(
          controller,
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      CalenderController2.prototype.getCalender
    ),

    function CalenderController2_getCalender(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getCalender.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      SettingController.prototype.getSettings
    ),

    function SettingController_getSettings(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(SettingController),
    ...fetchMiddlewares<RequestHandler>(
      SettingController.prototype.setSettings
    ),

    function SettingController_setSettings(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.setSettings.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
